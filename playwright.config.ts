 ...
 * on a unique port, then scans both themes with WCAG 2.0/2.1 A + AA rules.
 * The base path must match vite.config.ts (`/crypto-lab-syndrome-drain/`).
 */
const PORT = 4312;
const BASE = '/crypto-lab-syndrome-drain/';
